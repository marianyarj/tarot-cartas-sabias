    ...
    return (
        <>
            <nav className='mt-18 items-center box-border w-full flex flex-col'>
                <Link to="/">
                    <h1 className='cursor-pointer drop-shadow text-left text-4xl font-lato text-mustard md:text-6xl md:col-start-1 md:col-end-3 md:row-start-1'>
                        <span className='font-lavishly text-7xl md:text-9xl drop-shadow-lg'>C</span>artas
                    </h1>
                    <h1 className='cursor-pointer drop-shadow text-4xl font-lato text-mustard md:text-6xl md:col-start-2 md:row-start-2 xl:col-end-2 '><span className='font-lavishly text-7xl col-start-3 md:text-9xl drop-shadow-lg'>S</span>ábias</h1>
                </Link>
