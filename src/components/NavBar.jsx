        ...
        <>
            <nav className=' items-center  box-border w-full flex flex-col md:items-start md:place-items-start md:grid md:grid-cols-6 md:text-2xl xl:grid-cols-12'>
                ...
                <ul className='flex flex-col gap-8 mt-12 md:flex md:flex-row md:row-start-1 md:gap-4 md:col-end-8 xl:col-start-[-3] xl:row-start-2  2xl:col-end-[-5]'>
                    <li><Link to="/" className={`hover:bg-midnight hover:text-mustard cursor-pointer py-3 px-6 whitespace-nowrap text-lg md:text-2xl rounded-lg ${pageLocation.pathname === "/" ? "bg-mustard border-2 border-solid border-mustard text-midnight font-bold" : "border-2 border-solid border-mustard  text-mustard font-bold"} `}>Todas las cartas</Link></li>
                    <li><Link to="/tarotreading" className={`hover:bg-midnight hover:text-mustard cursor-pointer py-3 px-6 whitespace-nowrap text-lg md:text-2xl rounded-lg ${pageLocation.pathname === "/tarotreading" ? "bg-mustard border-2 border-solid border-mustard text-midnight font-bold" : "bg-sea/90 border-2 border-solid border-mustard text-mustard font-bold"} `}>Hacer Lectura</Link></li>
                </ul>
            </nav>
        </>
    )
